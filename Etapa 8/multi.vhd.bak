...
entity multi is
    port(clk       : IN  STD_LOGIC;
         ...
         wr_m_l    : IN  STD_LOGIC;
         w_b       : IN  STD_LOGIC;
			intr_enabled :IN  STD_LOGIC;--new
			intr_l	 :IN  STD_LOGIC;
			d_sys_l		:IN  STD_LOGIC;
			a_sys_l		:IN  STD_LOGIC;
			sys_state : OUT STD_LOGIC; --new
         ldpc      : OUT STD_LOGIC;
         wrd       : OUT STD_LOGIC;
         wr_m      : OUT STD_LOGIC;
         ldir      : OUT STD_LOGIC;
...
begin
	...
	wr_m <= wr_m_l when state=DEMW else 
			 '0';
	
	ldir  <= '0' when state=DEMW  or state = SYSTEM else 
			   '1';
	
	ins_dad  <= '1' when state=DEMW else 
			      '0';
