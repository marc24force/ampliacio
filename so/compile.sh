...
sisa-ld -s -T system.lds rsg.o system.o -o tmp_system.o
...
sisa-ld -T system.lds rsg.o system.o -o tmp_system.o

sisa-objdump -S -x -w --section=.sistema tmp_system.o >system.dis
sisa-objdump -S -x -w --section=.sysdata tmp_system.o >>system.dis

rm system.o tmp_system.o system.code system.data rsg.o 
cp system.code.DE1.hex ../sisa-emu/syscode.hex
cp system.data.DE1.hex ../sisa-emu/sysdata.hex
