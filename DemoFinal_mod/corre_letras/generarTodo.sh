...
sisa-gcc -g3 -O0 -c -Wall lib_sisa.c -o lib_sisa.o
...
sisa-ld -s -T system.lds entrada.o lib_sisa.o corre_letras.o -o temp_corre_letras.o
...
sisa-ld -T system.lds entrada.o corre_letras.o lib_sisa.o -o temp_corre_letras.o
...
cp corre_letras.code.DE1.hex ../../sisa_emu/. 
cp corre_letras.data.DE1.hex ../../sisa_emu/. 

rm lib_sisa.o entrada.o corre_letras.o temp_corre_letras.o corre_letras.code corre_letras.data
